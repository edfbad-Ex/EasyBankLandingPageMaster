        ...
        <div className="Container-Footer">
            ...
            <div className="Container-Footer-Childs">
                ...
                <div className="Container-Footer-Child">
                    ...
                    <ul className="Container-Footer-Child-Links">
                        
                        <li tabIndex="7" onClick={About}><span>About Us</span></li>
                        <li><span>Contact</span></li>
                        <li tabIndex="9" onClick={Blog}><span>Blog</span></li>
                ...
                <div className="Container-Footer-Child">
                    ...
                    <ul className="Container-Footer-Child-Button">

                        <li>

                            <button className="Button-Request-Invite3">Request invite</button>

                        </li>

                        <li>

                            <span className="Container-Footer-Child-Button-Span">© Easybank. All Rights Reserved</span>
