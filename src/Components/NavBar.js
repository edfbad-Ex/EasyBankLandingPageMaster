        ...
        if (mql1.matches){
            ...
            Menu.addEventListener("click", function () {
                ...
                if (NavBar_position != 1) {
                    ...
                    NavBarBackground.style.background = "linear-gradient(to bottom, hsla(248, 47%, 29%, 0.900), transparent)";
        ...
        <div className="Container-NavBar" onLoad={Menu} onChange={MenuC}>
            ...
            <div className="NavBar" id="NavBar-Background">
                ...
                <div className="NavBar-Child">
                    ...
                    <img tabIndex="1" onClick={Home} src={Logo} className="NavBar-Logo" alt="Logo" />
